    ...
    <div class="container">
        ...
        <div style="margin-top: 20px;">
            <table width="100%">
                <tr>
                    <td width="40%">
                        <div>HORA REAL: HH:{{ $orden->fecha_fin_atencion ? $orden->fecha_fin_atencion->format('h') : '_______' }} M:{{ $orden->fecha_fin_atencion ? $orden->fecha_fin_atencion->format('i') : '_______' }} {{ $orden->fecha_fin_atencion ? $orden->fecha_fin_atencion->format('a') : '' }}</div>
